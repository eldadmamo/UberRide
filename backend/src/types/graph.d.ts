...
export interface GetNearbyRidesReponse {
  ok: boolean;
  error: string | null;
  ride: Ride | null;
}
...
export interface Mutation {
  ...
  DeletePrice: DeletePriceResponse;
  ...
  EmailSignInVerify: EmailSignInVerifyResponse;
...
export interface DeletePriceMutationArgs {
  placeId: number;
}
...
export interface EmailSignInVerifyMutationArgs {
  email: string;
  password: string;
}
...
export interface ToogleDrivingModeResponse {
  ok: boolean;
  error: string | null;
}
